...
affected <- dbExecute(tripdb, "DELETE FROM trips_cleaned WHERE start_lat = end_lat AND start_lng = end_lng")
print(sprintf("%d trips with the same initial and final latitude and longitude were deleted.\n", affected))
dbDisconnect(tripdb)
